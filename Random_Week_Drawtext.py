...
# -*- coding: utf-8 -*-
"""
Created on Sat Apr 15 22:08:33 2017
...
for i in range(sheet2.nrows-2):
    if time_stamp[i+1] != time_stamp[i]:
        Tim = Tim+1
        '''
    if time_stamp[i+1] != time_stamp[i] and Tim-1==16:  
        previous_row = i+1    
    if time_stamp[i+1] != time_stamp[i] and Tim-1>16 and Tim-1<=17:
        '''
    if time_stamp[i+1] != time_stamp[i]:
        ...
        text2='5/'+"{}".format(int((Tim-1)*15/1440)+5)+'/2014'
