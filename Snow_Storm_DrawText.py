...
# -*- coding: utf-8 -*-
"""
Created on Sun Apr  9 12:10:58 2017
...
file_location2 = "/Users/wangtianpei/Desktop/python/Snow_Storm.xlsx"
...
for i in range(sheet2.nrows-2):
    if time_stamp[i+1] != time_stamp[i]:
        Tim = Tim+1
        '''
    if time_stamp[i+1] != time_stamp[i] and Tim-1==92:  
        previous_row = i+1    
    if time_stamp[i+1] != time_stamp[i] and Tim-1>92 and Tim-1<=286:
        '''
    if time_stamp[i+1] != time_stamp[i]:        
